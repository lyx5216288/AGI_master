...
public class MainMenuActivity extends AppCompatActivity {
    ...
    private EditText phoneNum,phoneImsi;
    public CheckBox imsiflag;
    ...
    private static final String TARGET_IMSI = "target_imsi";
    ...
    public void init() {
        ...
        texts = new String[]{this.getString(R.string.title_main_menu_cell_monitor),
                ...
                this.getString(R.string.title_main_menu_Basestationlocal),
                "基站定位",
        ...
        phoneImsi = (EditText) findViewById(R.id.main_menu_target_imsi_num);
        imsiflag= (CheckBox) findViewById(R.id.main_menu_target_imsi_num_save);
...
//        if (!agiUnionSP.getString(TARGET_IMSI,"").equals("")){
            Global.Configuration.targetPhoneImsi = agiUnionSP.getString(TARGET_IMSI,"");
//        }
//        if (agiUnionSP.getBoolean("imsiflag",false)){
            Global.Configuration.imsiflag = agiUnionSP.getBoolean("imsiflag",false);
//        }
        phoneImsi.setText(Global.Configuration.targetPhoneImsi);
        imsiflag.setChecked(Global.Configuration.imsiflag);
        Global.Configuration.model = agiUnionSP.getString(MODEL, "carry").equals("carry") ? Status.Model.CARRY : Status.Model.VEHICLE;
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences.Editor edit= agiUnionSP.edit();
                if(phoneImsi.getText().toString().toCharArray().length==15){
                    Global.Configuration.targetPhoneImsi = phoneImsi.getText().toString();
                    Global.Configuration.imsiflag = imsiflag.isChecked();
                    edit.putString(TARGET_IMSI,Global.Configuration.targetPhoneImsi);
                    edit.putBoolean("imsiflag",Global.Configuration.imsiflag);
                    edit.commit();
                }else {
                    Toast.makeText(MainMenuActivity.this, "请填入有效的IMSI！", Toast.LENGTH_SHORT).show();
//                    Global.Configuration.targetPhoneImsi ="000000000000000";
//                    Global.Configuration.imsiflag = false;
//                    edit.putString(TARGET_IMSI,"");
//                    edit.putBoolean("imsiflag",false);
//                    edit.commit();
                }
            }
        });
...
//                    Toast.makeText(MainMenuActivity.this, "请先选择守控小区", Toast.LENGTH_SHORT).show();
                    break;
...
//                    startActivity(new Intent(MainMenuActivity.this, LocalInfoActivity.class));
                    startActivity(new Intent(MainMenuActivity.this,LbsLocationActivity.class));
                    break;
                case R.drawable.map11:
                    startActivity(new Intent(MainMenuActivity.this, LBSActivity.class));
                    break;
            }
        }
    }
