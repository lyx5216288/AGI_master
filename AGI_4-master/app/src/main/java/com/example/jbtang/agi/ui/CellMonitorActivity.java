...
public class CellMonitorActivity extends AppCompatActivity {
    ...
    public void initData() {
        ...
        sharedPreferences =  getSharedPreferences(CELLMONITOR_DERECTORY, Context.MODE_PRIVATE);
        Context c = null;
        try {
        ...
        if(c!=null) {
            agi4bufferSP = c.getSharedPreferences(FINDSTMSI_DERECTORY, Context.MODE_PRIVATE);
            if(!agi4bufferSP.getString(TARGETEARFCN,"").equals("") && !agi4bufferSP.getString(TARGETPCI,"").equals("")) {
                manualEARFCN.setText(agi4bufferSP.getString(TARGETEARFCN, ""));
                manualPCI.setText(agi4bufferSP.getString(TARGETPCI, ""));
