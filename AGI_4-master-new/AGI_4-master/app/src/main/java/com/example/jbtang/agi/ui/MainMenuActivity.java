...
import com.example.jbtang.agi.dao.logInfos.LogInfoManager;
...
public class MainMenuActivity extends AppCompatActivity {
    ...
    public void init() {
        ...
        saveToCache();
        saveToDAO();
        agi4SP = getSharedPreferences(MAINMENU_DERECTORY, Context.MODE_PRIVATE);
        Context c = null;
        try {
        ...
        if(c!=null) {
            agi4bufferSP = c.getSharedPreferences(MAINMENU_DERECTORY, Context.MODE_PRIVATE);
            if(!agi4bufferSP.getString(TARGET_PHONE,"").equals(""))
                Global.Configuration.targetPhoneNum = agi4bufferSP.getString(TARGET_PHONE,"");
        } else if(!agi4SP.getString(TARGET_PHONE,"").equals("")){
            Global.Configuration.targetPhoneNum = agi4SP.getString(TARGET_PHONE,"");
        }
        if (!agi4SP.getString(TARGET_IMSI,"").equals("")) {
            Global.Configuration.targetPhoneImsi = agi4SP.getString(TARGET_IMSI, "");
        }
        if (agi4SP.getBoolean("imsiflag",false)){
            Global.Configuration.imsiflag = agi4SP.getBoolean("imsiflag",false);
        }
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((!phoneImsi.getText().toString().equals(""))){
                    ...
                    SharedPreferences.Editor edit= agi4SP.edit();
