...
public class Device {
    ...
    public Timer getStatuTimer(){
        return statuTimer;
    }
    public void setStatuTimer(Timer timer){
        this.statuTimer=timer;
    }

    public void setDeviceStatus(Status.DeviceStatus status){
        this.status=status;
